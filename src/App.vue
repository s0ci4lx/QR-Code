    ...
    <div class="card w-full max-w-md glass-card shadow-2xl transition-all duration-500 hover:shadow-purple-500/20 z-10">
      <div class="card-body items-center text-center p-6 space-y-4">
        ...
        <label class="swap swap-rotate absolute top-4 right-4">
          ...
          />
          <!-- Sun icon (Light mode) - shown when checked is false (swap-off) -->
          <svg
          ...
          >
            <path
              d="M12 7a5 5 0 1 0 0 10 5 5 0 0 0 0-10zM12 2a1 1 0 0 1 1 1v1a1 1 0 0 1-2 0V3a1 1 0 0 1 1-1zM12 20a1 1 0 0 1 1 1v1a1 1 0 0 1-2 0v-1a1 1 0 0 1 1-1zM4.93 4.93a1 1 0 0 1 1.41 0l.71.71a1 1 0 0 1-1.41 1.41l-.71-.71a1 1 0 0 1 0-1.41zM17.07 17.07a1 1 0 0 1 1.41 0l.71.71a1 1 0 0 1-1.41 1.41l-.71-.71a1 1 0 0 1 0-1.41zM2 12a1 1 0 0 1 1-1h1a1 1 0 0 1 0 2H3a1 1 0 0 1-1-1zM21 12a1 1 0 0 1 1-1h1a1 1 0 0 1 0 2h-1a1 1 0 0 1-1-1zM4.93 19.07a1 1 0 0 1 0-1.41l.71-.71a1 1 0 1 1 1.41 1.41l-.71.71a1 1 0 0 1-1.41 0zM17.07 6.93a1 1 0 0 1 0-1.41l.71-.71a1 1 0 1 1 1.41 1.41l-.71.71a1 1 0 0 1-1.41 0z"
            />
          </svg>
          <!-- Moon icon (Dark mode) - shown when checked is true (swap-on) -->
          <svg
